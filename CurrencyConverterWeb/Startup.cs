...
using CurrencyConverter.DomainService;
...
namespace CurrencyConverterWeb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IReadCurrencyApiService, ReadCurrencyApiService>();
            services.AddSingleton<IUpdateCurrencyAmountHostedService, UpdateCurrencyAmountHostedService>();
